      ...
      <div className='flex flex-col items-center'>
        <div className='flex flex-col items-start justify-start pt-2 px-3'>
          <div className='flex flex-row justify-start w-full items-start'>
            <span className='text-black/80 text-[13px] font-semibold pr-2 tracking-wide'>Weather data provided by</span>
            <span className='text-black/80 text-[13px] font-semibold flex flex-row items-center hover:text-black cursor-pointer tracking-wide'>
